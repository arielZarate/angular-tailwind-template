...
Tiene una estructura basica de servicio para ser usada por otros services en cada componente stanalone
...
y su uso en el componente Products
...
#### NOTA para poder injectar los services se debe importar en el app.config.ts el prodiceHttpClient()
